...
(function(exports) {
  ...
  var myDom2 = new Halogen_VDom_Types.Elem(new Halogen_VDom_Types.ElemSpec(Data_Maybe.Nothing.value, "linearLayout", "2"), [ new Halogen_VDom_Types.Text("hi") ]);
  var myDom1 = new Halogen_VDom_Types.Elem(new Halogen_VDom_Types.ElemSpec(Data_Maybe.Nothing.value, "linearLayout", "1"), [ new Halogen_VDom_Types.Text("hello") ]);
  ...
  var main = function __do() {
      ...
      $foreign.appendChildToBody(Halogen_VDom_Machine.extract(v1))();
      var v2 = Halogen_VDom_Machine.step(v1)(myDom2)();
